...
//
// for (let i in books){
//     if(books[i].pageCount > books[maxPage].pageCount){
//         maxPage = i;
//     }else if(books[i].genre > books[maxGenre].genre){
//         maxGenre = i;
//     }else if(books[i].name > books[maxName].name){
//         maxName = i;
//     }
// }
// console.log(books[maxPage].name);
// console.log(books[maxGenre].name);
// console.log(books[maxName].name);
